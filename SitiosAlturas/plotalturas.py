...
#########################################################################
os.system("python sorteador.py "+sys.argv[1]+" 1 > misdatos.dat")
...
yticks(fontsize=32)
xticks(x,labels, rotation='vertical',fontsize=30)

# Provide tick lines across the plot to help your viewers trace along
# the axis ticks. Make sure that the lines are light and small so they
# don't obscure the primary data lines.
for y in range(0,7000 , 1000):
  plot(range(0, 31), [y] * len(range(0, 31)), "--", lw=0.5, color="black", alpha=0.3)
...
text(15, 6500, "LAGO sites", fontsize=40, ha="center")
text(-5, 3500, "m a.s.l", fontsize=35, ha="center",rotation='vertical')
lg = ax.legend(loc='upper left', fontsize=26, numpoints=1)
